...
protected:
    string Name; //by moving this into protected you can access it in child classes
...
public:
    ...
    void PrepareLesson()
    {
        std::cout << Name << " is going to teach a lesson of " << Subject << std::endl;
    }
};

int main()
{
    Developer d = Developer("Saldina", "Yotube", 25, "Javascript");
    Teacher t = Teacher("John", "Youtube", 35, "History");
    d.FixBugs();
    t.PrepareLesson();
...
//3. Inheritance
// let say we have to class a Parent class and a child class
//the parent class have some attributes or behviour or let say members
//the child class become child class when it  decide to inherit from the parent class
//so it also possess those attributes,behviour or members
//the child class can also have its own members
// in inheritence, we take same parameter of parent class
//by :Employee(){}
//in this also we have to take care of our constructor
//by moving a attribute from private to protected, we can use it in child class
